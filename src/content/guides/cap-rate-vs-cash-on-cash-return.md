...
Test your own deal with the [rental property calculator](/rental-property-calculator/).
...
- adding value through renovation (see the [BRRRR calculator](/brrrr-calculator/));
...
- **DSCR (debt service coverage ratio):** rent ÷ (principal, interest, taxes, insurance and HOA). It shows how lenders judge whether the rent covers the loan; see the [DSCR loan calculator](/dscr-loan-calculator/).
