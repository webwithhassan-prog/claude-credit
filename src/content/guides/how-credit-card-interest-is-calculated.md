...
Your credit card statement shows an annual percentage rate (APR), but card issuers don't charge interest once a year. They charge it **every day**, based on your balance, and add it to your bill each month.
...
Because the minimum shrinks as your balance falls, paying only the minimum can take **more than 20 years**. The [credit card payoff calculator](/credit-card-payoff-calculator/) shows how much faster a fixed payment gets you out.
...
5. **Move the balance** to a 0% balance transfer card. Check the fee and the promotion length with the [balance transfer calculator](/balance-transfer-calculator/).
6. **Target your highest-APR card first** if you have several, using the avalanche method in our [debt payoff calculator](/debt-payoff-calculator/).

**Sources:**
- [CFPB: credit cards](https://www.consumerfinance.gov/consumer-tools/credit-cards/)
- [Regulation Z §1026.7](https://www.consumerfinance.gov/rules-policy/regulations/1026/7/) (periodic statements)
- [Regulation Z §1026.53](https://www.consumerfinance.gov/rules-policy/regulations/1026/53/) (allocation of payments)
- [Regulation Z §1026.55](https://www.consumerfinance.gov/rules-policy/regulations/1026/55/) (rate increases)
