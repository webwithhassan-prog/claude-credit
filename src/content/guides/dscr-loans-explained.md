...
Commercial and multifamily lenders often use a stricter version: **net operating income ÷ annual debt service**. That subtracts vacancy and operating expenses first, so the same property shows a lower ratio. Our [DSCR loan calculator](/dscr-loan-calculator/) shows both.
...
1. **Increase the down payment.** A smaller loan means a smaller payment.
2. **Buy down the rate** with points, if you'll hold the loan long enough to recoup them.
3. **Choose an interest-only period,** if the lender calculates DSCR on the interest-only payment.
4. **Document higher market rent** with comparable rentals, or improve the property before appraisal.
5. **Lower taxes and insurance.** Shop insurance and review your tax assessment.
6. **Ask about 40-year terms** or longer amortization, which some lenders offer.
...
If you're pulling equity from your own home to fund a purchase, compare the options with the [cash-out refinance vs HELOC calculator](/cash-out-refinance-vs-heloc-calculator/).
...
- [Fannie Mae single-family resources (Form 1007 rent schedule)](https://singlefamily.fanniemae.com/)
