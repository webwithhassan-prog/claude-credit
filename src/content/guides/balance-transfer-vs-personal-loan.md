...
Run your own numbers with the [balance transfer calculator](/balance-transfer-calculator/) and the [debt consolidation calculator](/debt-consolidation-calculator/).
...
See where you stand with the [credit utilization calculator](/credit-utilization-calculator/).

## A simple decision rule

1. **Can you pay off the balance, plus a 3%–5% fee, within 12–21 months?** Choose a balance transfer, and set the monthly payment to (balance + fee) ÷ promotional months.
2. **If not,** compare a personal loan's **APR** with what you'd pay on the transfer after the promotion ends. Choose the lower total cost, not just the lower payment.
3. **If you qualify for neither,** focus on a disciplined payoff plan, such as the avalanche or snowball method (try the [debt payoff calculator](/debt-payoff-calculator/)). Consider a nonprofit credit counseling agency, which may be able to arrange lower card rates through a debt management plan.

**Sources:**
- [CFPB: credit cards](https://www.consumerfinance.gov/consumer-tools/credit-cards/)
- [Regulation Z §1026.53](https://www.consumerfinance.gov/rules-policy/regulations/1026/53/) (allocation of payments)
- [Regulation Z §1026.55](https://www.consumerfinance.gov/rules-policy/regulations/1026/55/) (limits on rate increases)
